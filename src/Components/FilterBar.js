     ...
     <div className="col-sm-12" >
      <div className="input-group" >
       ...
       <div className="input-group-btn" >
        <button type="button" className="btn btn-primary dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" ><span className="label-icon" >Category</span> <span className="caret" >&nbsp;</span></button>
        ...
        <button id="searchBtn" type="button" class="btn btn-primary btn-search" ><span className="glyphicon glyphicon-search" >&nbsp;</span> <span className="label-icon" >Search</span></button>
       </div>
      </div>
     </div>
  </div>
