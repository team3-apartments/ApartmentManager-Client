...
class Home extends Component {
  ...
  colFormatter = (event, cell, row) => {
    ...
    //return <a href = '/apartmentDetail'> <Link to ={{pathname: '/apartmentDetail',search: '?apartmentBuilding='+ cell.apartmentBuilding + '?apartmentNumber='+ cell.ApartmentNumber}}/>  {cell.apartmentNumber}</a>;
  }
